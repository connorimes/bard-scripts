...
echo $1 > /sys/devices/system/cpu/cpu4/cpufreq/scaling_setspeed
echo $1 > /sys/devices/system/cpu/cpu5/cpufreq/scaling_setspeed
echo $1 > /sys/devices/system/cpu/cpu6/cpufreq/scaling_setspeed
echo $1 > /sys/devices/system/cpu/cpu7/cpufreq/scaling_setspeed
